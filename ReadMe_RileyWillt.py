# -*- coding: utf-8 -*-
"""
Created on Wed Dec  9 14:05:28 2020
...
'''
This file is the condenser file that Chad made. I modified it slightly to run as a function with an input of the T_steam_in
that returns the T_steam_out. I use it in many of my files.
'''

# 8. SteamGenerator.py

'''
This file is the steam generator that Matt made. I use it in many of my files.
'''
