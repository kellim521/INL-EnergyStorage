...
import TESmodel_KelliWard as tmodel
from Woody_ReactorLoopFullDay import FullDayReactor
...
if __name__ == '__main__':
    ...
    print('Select Option')
    print('1. Run with TES exergy calc and full reactor model (warning-will take over an hour)')
    print('2. Run reactor model, but do not run TES exergy calc (warning-will take 45+ mins)')
    print('3. Run TES exergy calc, but use saved reactor outputs (warning-will take 30+ mins')
    print('4. Do not run TES exergy calc and used saved reactor data (fastest run time)')
    option = input('Enter option: ')
    
    # TES/reactor if selected
    ...
    if option == '1' or option == '2':
        ...
        exergy = tmodel.exergy(ratio, TES)
