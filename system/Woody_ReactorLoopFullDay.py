...
#    
MyData = pd.read_excel("C:/Users/Yugi/Documents/Senior Design 2/Solar_Power_Data.xlsx", sheet_name = "Min(SolarP)") #extracting values of solar power generated in 10 min steps
...
MyData2 =pd.read_excel("C:/Users/Yugi/Documents/Senior Design 2/Solar_Power_Data.xlsx", sheet_name = "Min(Reactor)")# extracting mass flow rate values for each 10 min cycle on the cold side of the heat exchanger
MyData3 =pd.read_excel("C:/Users/Yugi/Documents/Senior Design 2/Solar_Power_Data.xlsx", sheet_name = "Min(Solar)")
#
...
#
SolarPower = mergedf[1:1442]
#Reactivity =mergedf1[3:80:5]
mdot_cA =mergedf2[1:1442]
mdot_solar = mergedf3[1:1442]

for j in range(1440):
    """ Power of the reactor is dependent on the mass flow rate of the solar data in 
    cold side of the IHE, this causes a change in the reactor cold side IHE to balance 
    the TES system to ensure that it doesnt become overloaded. Depending on the change in
    mass flow rate of the solar data this will cause a corresponding change in reactor power
    to ensure that that coolant inside the core remains in a safe range."""
#    if SolarPower[j] < 50:
#       n_e = 230.05 
