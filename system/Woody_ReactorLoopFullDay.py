...
#    
MyData = pd.read_excel("Solar_Power_Data.xlsx", sheet_name = "Min(SolarP)") #extracting values of solar power generated in 10 min steps
...
MyData2 =pd.read_excel("Solar_Power_Data.xlsx", sheet_name = "Min(Reactor)")# extracting mass flow rate values for each 10 min cycle on the cold side of the heat exchanger
MyData3 =pd.read_excel("Solar_Power_Data.xlsx", sheet_name = "Min(Solar)")
#
